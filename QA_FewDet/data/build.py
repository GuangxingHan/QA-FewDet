...
from QA_FewDet.data.dataset_mapper_pascal_voc import DatasetMapperWithSupportVOC
from QA_FewDet.data.dataset_mapper_coco import DatasetMapperWithSupportCOCO
